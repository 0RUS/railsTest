...
class DoctorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doctor" do
    assert_difference("Doctor.count") do
      post doctors_url, params: { doctor: { cost: @doctor.cost, free: @doctor.free, name: @doctor.name } }
    end
  ...
  test "should update doctor" do
    patch doctor_url(@doctor), params: { doctor: { cost: @doctor.cost, free: @doctor.free, name: @doctor.name } }
